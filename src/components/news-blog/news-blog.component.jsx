...
const NewsBlog = () => (
    <div className="news-blog">
        ...
        <div className="blog-2">
            <h1>Cooking Food With Love</h1>
            <div className="bolg-2-detail">
                <span>APRIL 18, 2015 IN RECIPE</span>
                <span>NO COMMENT</span>
                <h3>READ MORE</h3>
            </div>
        ...
        <div className="blog-3">
            <h1>Modern Fusion Cuisine</h1>
            <div className="bolg-3-detail">
                <span>APRIL 17, 2015 IN RECIPE</span>
                <span>NO COMMENT</span>
                <h3>READ MORE</h3>
            </div>
        ...
        <div className="blog-4">
            ...
            <div className="bolg-4-detail">
                <span>APRIL 16, 2015 IN COOKING</span>
                <span>NO COMMENT</span>
                <h3>READ MORE</h3>
            </div>
        ...
        <div className="blog-5">
            <h1>Our Premium Food Recipe</h1>
            <div className="bolg-5-detail">
                <span>APRIL 9, 2015 IN ASIAN</span>
                <span>NO COMMENT</span>
                <h3>READ MORE</h3>
            </div>
        ...
        <div className="blog-6">
            <h1>Life is a combination of cooking</h1>
            <div className="bolg-6-detail">
                <span>APRIL 5, 2015 IN COOKING</span>
                <span>NO COMMENT</span>
                <h3>READ MORE</h3>
            </div>
